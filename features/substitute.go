...
func HandleSubstituteJump(optionalData ...interface{}) {
	...
	log.Debug(fmt.Sprintf("HandleSubstituteJump searchStart=%d searchEnd=%d replaceStart=%d replaceEnd=%d currentPos=%d", searchStart, searchEnd, replaceStart, replaceEnd, currentPos))
